...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_availability_doctor_id", "availability", ["doctor_id"], unique=False
    )
    ...
    op.create_index(
        "ix_appointment_patient_id", "appointment", ["patient_id"], unique=False
    )
    op.create_index(
        "ix_appointment_doctor_id", "appointment", ["doctor_id"], unique=False
    )
